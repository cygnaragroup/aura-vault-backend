"""
Standalone script to run the actual task work.
This script is executed in Kubernetes Jobs.
"""
import os
import sys
import time
...
# Setup Django
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'auravault.settings')
django.setup()

def run_task(photo_id):
    """
    Run the actual RAM-intensive task work.
    
    Args:
        photo_id: The ID of the Photo instance
    """
...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        print("Usage: python task_runner.py <photo_id>")
        sys.exit(1)
